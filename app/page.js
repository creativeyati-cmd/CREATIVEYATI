...
import { getCarouselSettings, getCourseSettings } from "@/lib/data/settings";
...
export default async function Home() {
  const [{ videos, error }, site, courseSettings, carouselSettings, socialLinks] = await Promise.all([getPublicPortfolio(), getSiteContent(), getCourseSettings(), getCarouselSettings(), getPublicSocialLinks()]);
