...
export const INTERACT = {
  ...
  TOUCH_DRAG: 1, TOUCH_EASE: 0.22, TOUCH_CLICK_SLOP: 12,
};
...
export const ENTRY = {
  enabled: true, delay: 0.5, startH: 80, riseDuration: 1, stagger: 0.07,
  riseEase: "power3.out", fromBelow: 0.9, growDelay: 0.25,
  growDuration: 2.15, growEase: "expo.inOut", growStagger: 0.085,
  growDir: "inward", lensBloom: 1.4, lensBloomEase: "power2.inOut",
};
