...
export function createCarouselGui(carousel) {
  const { lensUniforms, refreshLayout, replayEntry, setInteraction } = carousel;
  ...
  scrollFolder.add(CONFIG, "AUTO_EASE", 0.01, 0.12, 0.005).name("autoplay ease");
  const autoplayFolder = gui.addFolder("Autoplay");
  autoplayFolder.add(AUTOPLAY, "enabled").name("enabled");
  autoplayFolder.add(AUTOPLAY, "initialDelay", 500, 5000, 100).name("initial delay");
  autoplayFolder.add(AUTOPLAY, "rest", 2000, 8000, 100).name("desktop rest");
  autoplayFolder.add(AUTOPLAY, "mobileRest", 2000, 8000, 100).name("mobile rest");
  autoplayFolder.add(AUTOPLAY, "resumeDelay", 2000, 8000, 100).name("resume delay");
