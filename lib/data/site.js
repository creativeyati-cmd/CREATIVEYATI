...
export const siteDefaults = {
  ...
  contactHeading: "Have a story in mind?", contactCopy: "Tell me what you are making and where it needs to go.", publicEmail: "", phone: "", bookingUrl: "https://cal.com/yati-creative-dyfafh", instagramUrl: "", youtubeUrl: "", footerText: "",
  accentColor: "#a3c900", lightBackground: "#ffffff", darkBackground: "#121212",
};
...
export async function getSiteContent() {
  ...
  return { ...siteDefaults, ...(data?.value || {}), ...(contact?.value || {}) };
}
